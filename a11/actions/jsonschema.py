...
"""JSON Schema for a Python type, and tidying the result.

Lives in the actions layer because a port's `json_schema` is part of describing
an action, and `a11.actions.describe` must be able to derive one without
importing an SDK. It began under `a11.sdk.llm_tools`, which still re-exports it
for the tool adapters that were its first callers.
"""
