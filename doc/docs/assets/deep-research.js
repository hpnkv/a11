...
// demo/deep_research.ts
var DEEP_RESEARCH_SCHEMA = new ActionSchema({
  name: "deep-research",
...
var DeepResearchDemo = class {
  backend = new BackendControls("research");
  errors = document.querySelector("#research-errors");
  report = document.querySelector("#research-report");
  plan = document.querySelector("#research-plan");
  log = document.querySelector("#research-log");
  async run(topic) {
...
var root = document.querySelector("#research-demo");
if (root) {
