...
class FlowLexer : LexerBase() {
    ...
    private fun punctuation(lexical: String?): IElementType = when (lexical) {
        ...
        while (at < text.length) {
            ...
            when {
                letter == '#' -> {
                    ...
                    slices.add(Slice(FlowTokens.COMMENT, at, stop))
                    at = stop
                }
                ...
                letter == '"' -> {
                    ...
                    slices.add(Slice(FlowTokens.STRING, at, stop.coerceAtMost(text.length)))
                ...
                letter.isLetter() || letter == '_' || letter == '$' -> {
                    ...
                    slices.add(Slice(FlowTokens.IDENTIFIER, at, stop))
                    at = stop
                }
